...
Declare Function VII_WriteBytes Lib "Ginkgo_Driver.dll" (ByVal DevType As Long, ByVal DevIndex As Long, ByVal I2CIndex As Long, ByVal Addr As Integer, ByVal SubAddr As Long, ByRef pWriteData As Byte, ByVal WriteLen As Integer) As Long
Declare Function VII_ReadBytes Lib "Ginkgo_Driver.dll" (ByVal DevType As Long, ByVal DevIndex As Long, ByVal I2CIndex As Long, ByVal Addr As Integer, ByVal SubAddr As Long, ByRef pReadData As Byte, ByVal ReadLen As Integer) As Long
Declare Function VII_SlaveReadBytes Lib "Ginkgo_Driver.dll" (ByVal DevType As Long, ByVal DevIndex As Long, ByVal I2CIndex As Long, ByRef pReadData As Byte, ByRef pLen As Integer) As Long
Declare Function VII_SlaveWriteBytes Lib "Ginkgo_Driver.dll" (ByVal DevType As Long, ByVal DevIndex As Long, ByVal I2CIndex As Long, ByRef pWriteData As Byte, ByVal WriteLen As Integer) As Long
Declare Function VII_SetUserKey Lib "Ginkgo_Driver.dll" (ByVal DevType As Long, ByVal DevIndex As Long, ByRef pUserKey As Byte) As Long
Declare Function VII_CheckUserKey Lib "Ginkgo_Driver.dll" (ByVal DevType As Long, ByVal DevIndex As Long, ByRef pUserKey As Byte) As Long
