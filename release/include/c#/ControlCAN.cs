...
namespace Ginkgo
{
    class ControlCAN
    {
        ...
        public struct VCI_BOARD_INFO_EX
        {
	        ...
	        public Byte[]		ProductName;	    //hardware name，for example: “Ginkgo-CAN-Adaptor\0”（note: include string null end‘\0’）
	        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public Byte[]		FirmwareVersion;	//firmware version
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
	        public Byte[]		HardwareVersion;	//hardware version
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
	        public Byte[]		SerialNumber;	    //adatper serial number
        }
        //Definition of CAN frame
        public struct VCI_CAN_OBJ
        {
            public UInt32   ID;         //Frame ID
